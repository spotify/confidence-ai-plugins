...
- `/confidence:migrate-optimizely <plan flag | plan code | execute <plan-file>>` — Migrate feature flags from Optimizely to Confidence SDK
...
- **migrate-optimizely** — Auto-triggers when the user asks to migrate Optimizely flags or transform SDK code to Confidence
